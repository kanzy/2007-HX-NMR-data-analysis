...
disp('check! currently peak(row) #65, 66, 67, 70, 71 as blank')
for i=1:N
...
disp('check! currently peak(row) #1, 2, 64 as non-exchange reference')
for i=1:N
...
for i=1:M
    ...
    j=0; if(ResidueNum>0&&ResidueNum<130) j=ResidueNum; end
